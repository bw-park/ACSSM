"""
This source code is derived from Pytorch S5 implementation (https://github.com/i404788/s5-pytorch/tree/master/s5)
which is ported version of "S5: Simplified State Space Layers for Sequence Modeling" (https://github.com/lindermanlab/S5)

Authors: Jimmy T.H. Smith, Andrew Warrington, Scott Linderman (ICLR 2023)
"""
